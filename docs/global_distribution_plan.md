...
- The current app/update source remains unpublished in an Android release; review it for production behavior before tagging v1.0.2.
...
6. [x] Create a published GitHub Release at a reviewed commit. `v1.0.1` contains the universal APK, three ABI-specific APKs, checksums, and release notes. Keep a stable app-release.apk asset name for the existing latest/download URL.
...
- [x] Release installation succeeds on the Android emulator; physical-device verification remains a separate check.
