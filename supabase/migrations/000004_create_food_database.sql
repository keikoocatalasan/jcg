...
CREATE INDEX IF NOT EXISTS idx_food_normalized_name ON FOOD_ITEM(normalized_name);
CREATE INDEX IF NOT EXISTS idx_food_category ON FOOD_ITEM(category_id);
CREATE INDEX IF NOT EXISTS idx_food_owner ON FOOD_ITEM(owner_user_id);
CREATE INDEX IF NOT EXISTS idx_food_active ON FOOD_ITEM(is_active);
CREATE INDEX IF NOT EXISTS idx_food_official ON FOOD_ITEM(is_official);
...
CREATE INDEX IF NOT EXISTS idx_food_serving_food ON FOOD_SERVING(food_id);
CREATE INDEX IF NOT EXISTS idx_food_serving_default ON FOOD_SERVING(is_default) WHERE is_default = TRUE AND is_active = TRUE;
...
CREATE INDEX IF NOT EXISTS idx_food_nutrition_food ON FOOD_NUTRITION_PROFILE(food_id);
CREATE INDEX IF NOT EXISTS idx_food_nutrition_serving ON FOOD_NUTRITION_PROFILE(serving_id);
CREATE INDEX IF NOT EXISTS idx_food_nutrition_active ON FOOD_NUTRITION_PROFILE(is_active) WHERE is_active = TRUE;
...
CREATE INDEX IF NOT EXISTS idx_food_price_food ON FOOD_PRICE(food_id);
CREATE INDEX IF NOT EXISTS idx_food_price_serving ON FOOD_PRICE(serving_id);
CREATE INDEX IF NOT EXISTS idx_food_price_active ON FOOD_PRICE(is_active) WHERE is_active = TRUE;
...
CREATE INDEX IF NOT EXISTS idx_food_change_log_food ON FOOD_CHANGE_LOG(food_id);

DROP TRIGGER IF EXISTS trg_food_item_updated_at ON FOOD_ITEM;
