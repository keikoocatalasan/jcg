...
class LocalTestDataSeeder {
  ...
  static Future<void> _seed() async {
    ...
    final foods = [
      ...
      _food(
        id: 'local-food-sunny-side-up-egg',
      ...
      _food(
        id: 'local-food-tomato-raw',
        name: 'Tomato (Kamatis, raw)',
        category: 'Vegetables',
      ...
      _food(
        id: 'local-food-beef-caldereta',
        name: 'Beef Caldereta (Kaldereta)',
        category: 'Meat and Poultry',
        servingLabel: '1 cup (250g, estimated)',
        servingGrams: 250,
        calories: 420,
        protein: 26,
        carbs: 18,
